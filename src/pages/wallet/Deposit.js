      ...
      >
        <div data-v-36cc3380="" className="Recharge__container">
          ...
          <div data-v-4f3d8608="" data-v-36cc3380="">
            ...
            <div
                data-v-4f3d8608=""
                className={`Recharge__container-tabcard__items ${activeSection === 'section1' || activeSection === 'section4' ? 'active' : ''}`}  onClick={() => showSection('section1')}
              >
              ...
              <div
                data-v-4f3d8608=""
                 className={`Recharge__container-tabcard__items ${activeSection === 'section2' || activeSection ==='section5' ? 'active' : ''}`}  onClick={() => showSection('section2')}
              >
                <div data-v-4f3d8608="" className="centers">
              ...
              <div
                data-v-4f3d8608=""
                className={`Recharge__container-tabcard__items ${activeSection === 'section3' || activeSection === 'section6' ? 'active' : ''}`} onClick={() => showSection('section3')}
              >
                <div data-v-4f3d8608="" className="centers">
          ...
          <div data-v-9e03166f="" className="Recharge__content">
            ...
            onClick={() => handleAmountClick(amount)}
              ...
              >
                <div data-v-9e03166f="" className="place-div">{activeSection === 'section1' || activeSection === 'section4' ? '₹' 
 : activeSection === 'section3' || activeSection === 'section6' ? 
    <img data-v-98c90f53="" src="/assets/png/trx.png" alt="" style={{width: '20px'}} /> 
 : activeSection === 'section2' || activeSection === 'section5' ? 
